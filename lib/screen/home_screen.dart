                ...
                children: [
                  Stack(
                    children: [
                      CircleAvatar(
                        radius: 30,
                        backgroundImage: NetworkImage("https://images.unsplash.com/photo-1611246981370-93febc04e6d5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y3V0ZSUyMGdpcmxzfGVufDB8fDB8fHww&w=1000&q=80"),
                      ),
                      Positioned(
                        bottom: 0,
                          right: 0,
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            ...
            buildNavBarItem(CupertinoIcons.number, -1),
      ...
      children: [
        Row(
          ...
          children: [
            GestureDetector(
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => ProfilScreen( url: urlProfilePhoto)));
              },
              child: Hero(
                tag: urlProfilePhoto,
                child: CircleAvatar(
